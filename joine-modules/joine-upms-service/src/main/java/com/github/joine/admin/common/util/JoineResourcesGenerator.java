package com.github.joine.admin.common.util;
 ...
 * @date 2017/10/29
 */
public class JoineResourcesGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://10.211.55.3:3306/joine?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false");
        mpg.setDataSource(dsc);

        // 策略配置
        StrategyConfig strategy = new StrategyConfig();
        // strategy.setCapitalMode(true);// 全局大写命名 ORACLE 注意
        strategy.setSuperControllerClass("com.github.joine.common.web.BaseController");
        // 表名生成策略
        ...
        pc.setParent("com.github.joine.admin");
