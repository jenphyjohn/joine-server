package com.github.joine.auth.feign;

import com.github.joine.auth.feign.fallback.UserServiceFallbackImpl;
 ...
 * @date 2017/10/31
 */
@FeignClient(name = "joine-upms-service", fallback = UserServiceFallbackImpl.class)
